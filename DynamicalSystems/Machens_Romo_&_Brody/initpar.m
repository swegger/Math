...
par.mfnoise  =   0;    %additive noise in mean-field simulation

%--------------stimulus onset/offset times
par.T       = 5000;  % task length
par.TSO1    =  500;  % onset of f1 (msec)
par.TSF1    = 1000;  % offset of f1 (msec)
par.TSO2    = 4000;  % onset of f2 (msec)
par.TSF2    = 4500;  % offset of f2 (msec)
