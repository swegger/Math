function [theta, logPosterior, exitflg, output] = FitExpRisePoissonObsMAP(x,y,theta_init,varargin)
%% FitGaussianMAP
%
...
[theta, feval, exitflg, output] = fmincon(f, theta_init, [],[],[],[],...
    [-Inf,-Inf,0,0],[Inf,Inf,Inf,Inf],[], options);
logPosterior = -feval;
