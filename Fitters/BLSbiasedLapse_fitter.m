function [wm, wy, b, lapse, llikelihood] = BLSbiasedLapse_fitter(x,y,varargin)
...
switch FitType
    ...
    case 'quad'
        ...
        BLSminimizant = @(p)logLikelihoodQUAD(p(1),p(2),p(3),p(4),N,x,y,xmin,xmax,dx,M,m,LapseSupport(1),LapseSupport(2));
