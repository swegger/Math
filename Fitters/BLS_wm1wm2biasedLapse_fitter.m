function [wm, wy, wm_drift, b, lapse, llikelihood, lmodelEvidence] = ...
    BLS_wm1wm2biasedLapse_fitter(x,y,varargin)
...
function logL = logLikelihoodQUAD(wm,wy,wm_drift,b,lapse,N,x,y,xmin,xmax,dx,M,m,pmin,pmax,ObsAct)
%% LOGLIKELIHOODQUAD
%
